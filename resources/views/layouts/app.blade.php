...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					@else
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><strong>Logged in as <em>{{ Auth::user()->name }}</em></strong> <span class="caret"></span></a>
	...
	<div id="main" class="container">
		...
		<div class="text-center">
			Built for <a href="http://laravel.com/">Laravel 5</a> by <a href="http://teamteatime.net/">TeamTeaTime</a>. Running laravel-forum 3.1.1 and laravel-forum-frontend 1.1.0.
			<br>
